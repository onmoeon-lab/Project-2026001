...
const getLocalImageBytes = async (url: string): Promise<Uint8Array> => {
...
export const generateDossierDocx = async (data: DossierProfile) => {
  const imageBytes = await getLocalImageBytes(Logo);
    ...
    sections: [
      {
        ...
        children: [
          ...
          createQuestionBlock(
            "Write a brief description about your home in the village and surroundings:",
            data.homeDescription,
          ),
          createQuestionBlock(
            "Give a short description of your school and of the study environment:",
    ...
    sections: [
      {
        ...
        children: [
          createHeaderTable(
            imageBytes,
            "Child Sponsorship Profile/Case History",
          ),
