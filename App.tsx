          ...
          {reportType === 'APR' && (
            ...
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
                ...
                <div className="p-6 space-y-4">
                    <DossierInput label="Write about yourself and your future" value={data.aboutSelfAndFuture} onChange={(v) => updateField('aboutSelfAndFuture', v)} type="textarea" enableAI={true} aiConfig={appSettings.aiConfig[EnhancementType.CHILD_NARRATIVE]} context={childContext} userCanEnhance={currentUser?.allowAI} apiKey={userApiKey} />
                    <DossierInput label="Brief description about your home..." value={data.homeDescription} onChange={(v) => updateField('homeDescription', v)} type="textarea" enableAI={true} aiConfig={appSettings.aiConfig[EnhancementType.CHILD_NARRATIVE]} context={childContext} userCanEnhance={currentUser?.allowAI} apiKey={userApiKey} />
                    <DossierInput label="Short description of your school..." value={data.schoolDescription} onChange={(v) => updateField('schoolDescription', v)} type="textarea" enableAI={true} aiConfig={appSettings.aiConfig[EnhancementType.CHILD_NARRATIVE]} context={childContext} userCanEnhance={currentUser?.allowAI} apiKey={userApiKey} />
                    <DossierInput label="Interesting story/experience..." value={data.interestingStory} onChange={(v) => updateField('interestingStory', v)} type="textarea" enableAI={true} aiConfig={appSettings.aiConfig[EnhancementType.CHILD_NARRATIVE]} context={childContext} userCanEnhance={currentUser?.allowAI} apiKey={userApiKey} />
                </div>
            </div>
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
                <div className="bg-slate-50 px-6 py-3 border-b border-slate-100 flex items-center gap-2">
                ...
                <div className="p-6">
                    <DossierInput label="Teacher's remarks" value={data.teachersRemarks} onChange={(v) => updateField('teachersRemarks', v)} type="textarea" enableAI={true} aiConfig={appSettings.aiConfig[EnhancementType.TEACHER_EVALUATION]} context={childContext} userCanEnhance={currentUser?.allowAI} apiKey={userApiKey} />
                </div>
            </div>
            </>
          )}
