...
import { FileDown, Sprout, LayoutTemplate, User as UserIcon, Quote, GraduationCap, PenTool, LogOut, Loader2, FileText, ClipboardList } from 'lucide-react';
                            ...
                            <div className="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
                                ...
                                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3">
                                    <div className="space-y-3">
                                        <DossierInput label="Name of Child" value={data.childName} onChange={(v) => updateField('childName', v)} userCanEnhance={currentUser?.allowAI} />
                                        <DossierInput label="Date of Birth" value={data.dob} onChange={(v) => updateField('dob', v)} placeholder="DD/MM/YYYY" userCanEnhance={currentUser?.allowAI} />
                                        <DossierInput label="Sponsorship Category" value={data.sponsorshipCategory} onChange={(v) => updateField('sponsorshipCategory', v)} userCanEnhance={currentUser?.allowAI} />
                                        <div className="grid grid-cols-2 gap-2">
                                            <DossierInput label="Gender" value={data.gender} onChange={(v) => updateField('gender', v)} userCanEnhance={currentUser?.allowAI} />
                                            <DossierInput label="Height (cm)" value={data.height} onChange={(v) => updateField('height', v)} userCanEnhance={currentUser?.allowAI} />
                                        </div>
                                        <DossierInput label="Personality" value={data.personality} onChange={(v) => updateField('personality', v)} userCanEnhance={currentUser?.allowAI} />
                                        <DossierInput label="Father's Name" value={data.fathersName} onChange={(v) => updateField('fathersName', v)} userCanEnhance={currentUser?.allowAI} />
                                        <DossierInput label="Father's Status" value={data.fathersStatus} onChange={(v) => updateField('fathersStatus', v)} userCanEnhance={currentUser?.allowAI} />
                                        <DossierInput label="Family Income Source" value={data.familyIncomeSource} onChange={(v) => updateField('familyIncomeSource', v)} userCanEnhance={currentUser?.allowAI} />
                                    </div>
                                    <div className="space-y-3">
                                        <DossierInput label="Aid No" value={data.aidNo} onChange={(v) => updateField('aidNo', v)} placeholder="AC-TON-XXXX" userCanEnhance={currentUser?.allowAI} />
                                        <DossierInput label="Donor Agency" value={data.donorAgency} onChange={(v) => updateField('donorAgency', v)} userCanEnhance={currentUser?.allowAI} />
                                        <DossierInput label="Aim in Life" value={data.aimInLife} onChange={(v) => updateField('aimInLife', v)} userCanEnhance={currentUser?.allowAI} />
                                        <div className="grid grid-cols-2 gap-2">
                                            <DossierInput label="Grade" value={data.grade} onChange={(v) => updateField('grade', v)} userCanEnhance={currentUser?.allowAI} />
                                            <DossierInput label="Weight (kg)" value={data.weight} onChange={(v) => updateField('weight', v)} userCanEnhance={currentUser?.allowAI} />
                                        </div>
                                        <DossierInput label="Academic Year" value={data.academicYear} onChange={(v) => updateField('academicYear', v)} userCanEnhance={currentUser?.allowAI} />
                                        <DossierInput label="Mother's Name" value={data.mothersName} onChange={(v) => updateField('mothersName', v)} userCanEnhance={currentUser?.allowAI} />
                                        <DossierInput label="Mother's Status" value={data.mothersStatus} onChange={(v) => updateField('mothersStatus', v)} userCanEnhance={currentUser?.allowAI} />
                                        <DossierInput label="Monthly Income (BDT)" value={data.monthlyIncome} onChange={(v) => updateField('monthlyIncome', v)} userCanEnhance={currentUser?.allowAI} />
                                    </div>
                                </div>
                            </div>
                            <div className="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
                                ...
                                <div className="p-6 space-y-4">
                                    <DossierInput label="Write about yourself and your future" value={data.aboutSelfAndFuture} onChange={(v) => updateField('aboutSelfAndFuture', v)} type="textarea" enableAI={true} aiConfig={appSettings.aiConfig[EnhancementType.CHILD_NARRATIVE]} context={childContext} userCanEnhance={currentUser?.allowAI} />
                                    <DossierInput label="Brief description about your home..." value={data.homeDescription} onChange={(v) => updateField('homeDescription', v)} type="textarea" enableAI={true} aiConfig={appSettings.aiConfig[EnhancementType.CHILD_NARRATIVE]} context={childContext} userCanEnhance={currentUser?.allowAI} />
                                    <DossierInput label="Short description of your school..." value={data.schoolDescription} onChange={(v) => updateField('schoolDescription', v)} type="textarea" enableAI={true} aiConfig={appSettings.aiConfig[EnhancementType.CHILD_NARRATIVE]} context={childContext} userCanEnhance={currentUser?.allowAI} />
                                    <DossierInput label="Interesting story/experience..." value={data.interestingStory} onChange={(v) => updateField('interestingStory', v)} type="textarea" enableAI={true} aiConfig={appSettings.aiConfig[EnhancementType.CHILD_NARRATIVE]} context={childContext} userCanEnhance={currentUser?.allowAI} />
                                </div>
                            </div>
                            <div className="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
                                <div className="bg-slate-50 px-6 py-3 border-b border-slate-100 flex items-center gap-2">
                                ...
                                <div className="p-6">
                                    <DossierInput label="Teacher's remarks" value={data.teachersRemarks} onChange={(v) => updateField('teachersRemarks', v)} type="textarea" enableAI={true} aiConfig={appSettings.aiConfig[EnhancementType.TEACHER_EVALUATION]} context={childContext} userCanEnhance={currentUser?.allowAI} />
                                </div>
                            </div>
                        </>
                    )}
                        ...
                        <>
                            <div className="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
                                ...
                                <div className="p-6 space-y-3">
                                    <DossierInput label="Name of Child" value={cspData.childName} onChange={(v) => updateCspField('childName', v)} userCanEnhance={currentUser?.allowAI} />
                                    <DossierInput label="Name of School" value={cspData.schoolName} onChange={(v) => updateCspField('schoolName', v)} userCanEnhance={currentUser?.allowAI} />
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <DossierInput label="Code / Aid No" value={cspData.aidNo} onChange={(v) => updateCspField('aidNo', v)} placeholder="AC-TON-XXXX" userCanEnhance={currentUser?.allowAI} />
                                        <DossierInput label="Donor Agency" value={cspData.donorAgency} onChange={(v) => updateCspField('donorAgency', v)} userCanEnhance={currentUser?.allowAI} />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
                                ...
                                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3">
                                    <DossierInput label="Sponsorship Category" value={cspData.sponsorshipCategory} onChange={(v) => updateCspField('sponsorshipCategory', v)} userCanEnhance={currentUser?.allowAI} />
                                    <DossierInput label="Aim in Life" value={cspData.aimInLife} onChange={(v) => updateCspField('aimInLife', v)} userCanEnhance={currentUser?.allowAI} />
                                    <DossierInput label="Date of Birth" value={cspData.dob} onChange={(v) => updateCspField('dob', v)} placeholder="DD/MM/YYYY" userCanEnhance={currentUser?.allowAI} />
                                    <DossierInput label="Birth Place" value={cspData.birthPlace} onChange={(v) => updateCspField('birthPlace', v)} userCanEnhance={currentUser?.allowAI} />

                                    <div className="grid grid-cols-2 gap-2">
                                        <DossierInput label="Gender" value={cspData.gender} onChange={(v) => updateCspField('gender', v)} userCanEnhance={currentUser?.allowAI} />
                                        <DossierInput label="Grade" value={cspData.grade} onChange={(v) => updateCspField('grade', v)} userCanEnhance={currentUser?.allowAI} />
                                    </div>
                                    <div className="grid grid-cols-2 gap-2">
                                        <DossierInput label="Height (cm)" value={cspData.height} onChange={(v) => updateCspField('height', v)} userCanEnhance={currentUser?.allowAI} />
                                        <DossierInput label="Weight (kg)" value={cspData.weight} onChange={(v) => updateCspField('weight', v)} userCanEnhance={currentUser?.allowAI} />
                                    </div>

                                    <DossierInput label="Language Known" value={cspData.languageKnown} onChange={(v) => updateCspField('languageKnown', v)} userCanEnhance={currentUser?.allowAI} />
                                    <DossierInput label="Hobby" value={cspData.hobby} onChange={(v) => updateCspField('hobby', v)} userCanEnhance={currentUser?.allowAI} />
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
                                ...
                                <div className="p-6 space-y-3">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <DossierInput label="Father's Name" value={cspData.fathersName} onChange={(v) => updateCspField('fathersName', v)} userCanEnhance={currentUser?.allowAI} />
                                        <DossierInput label="Literacy of Father" value={cspData.fatherLiteracy} onChange={(v) => updateCspField('fatherLiteracy', v)} userCanEnhance={currentUser?.allowAI} />
                                    </div>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <DossierInput label="Mother's Name" value={cspData.mothersName} onChange={(v) => updateCspField('mothersName', v)} userCanEnhance={currentUser?.allowAI} />
                                        <DossierInput label="Literacy of Mother" value={cspData.motherLiteracy} onChange={(v) => updateCspField('motherLiteracy', v)} userCanEnhance={currentUser?.allowAI} />
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <DossierInput label="Family Income Source" value={cspData.familyIncomeSource} onChange={(v) => updateCspField('familyIncomeSource', v)} userCanEnhance={currentUser?.allowAI} />
                                        <DossierInput label="Monthly Income (BDT)" value={cspData.monthlyIncome} onChange={(v) => updateCspField('monthlyIncome', v)} userCanEnhance={currentUser?.allowAI} />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
                                ...
                                <div className="p-6 space-y-4">
                                    <DossierInput
                                        ...
                                        type="textarea"
                                        enableAI={true}
                                        aiConfig={appSettings.aiConfig[EnhancementType.CASE_HISTORY_NARRATIVE]}
